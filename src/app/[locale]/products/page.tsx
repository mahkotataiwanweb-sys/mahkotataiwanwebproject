...
export default function ProductsPage() {
  ...
  // GSAP staggered grid animation when products load or category changes
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <div className="sticky top-0 z-30 bg-cream/95 backdrop-blur-md border-b border-navy/5 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div
            className="flex gap-3 overflow-x-auto scrollbar-hide pb-1 -mb-1"
            ...
            <button
              ...
              className={`shrink-0 px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 ${
                activeCategory === 'all'
                  ...
                  : 'bg-white text-navy/70 hover:bg-navy/5 hover:text-navy border border-navy/10'
              }`}
            >
              ✨ {t('viewAll')}
            </button>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-navy/40 text-lg">{t('noProducts')}</p>
                ...
                <div key={product.id} className="flex flex-col">
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <h3 className="font-heading text-base font-semibold text-navy mt-1 group-hover:text-red transition-colors duration-300 line-clamp-2">
                        {getLocalizedField(product, 'name', locale)}
                      </h3>
                      {/* Tap for details indicator */}
                      <div className="flex items-center gap-1 mt-2 text-navy/30 text-xs">
                        <ChevronDown
                  ...
                  {/* Slide-down Description Panel */}
                  <div
                    className={`overflow-hidden transition-all duration-500 ease-in-out ${
                      isOpen ? 'max-h-64 opacity-100 mt-2' : 'max-h-0 opacity-0 mt-0'
                    }`}
                  >
                    <div className="bg-white rounded-xl p-4 shadow-sm border border-navy/5">
